...
import { vertex, fragment } from '@/components/projectSection/ImageShader'
...
const ImageModel: React.FC<Props> = (props: Props) => {
    ...
    const textures = projectsData.map(project => useTexture(project.imgSrc));
